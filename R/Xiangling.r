...
#' rgb_xiangling()
#' rgb_xiangling(10)
#' rgb_xiangling(n = 10, alpha = 0.5)
#' rgb_xiangling(n = 20, alpha = 0.7, reverse = TRUE)
rgb_xiangling = function(n = 12, alpha = 1, reverse = FALSE){
	return(pal_xiangling(alpha = alpha, reverse = reverse)(n))
}
...
#' @examples
#' scale_color_xiangling()
#' scale_color_xiangling(FALSE)
#' scale_color_xiangling(alpha = 0.5)
#' scale_color_xiangling(FALSE, alpha = 0.7, reverse = TRUE)
scale_color_xiangling = function(discrete = TRUE, alpha = 1, reverse = FALSE, ...) {
	if(discrete){
		return(discrete_scale("colour", "xiangling", pal_xiangling(alpha = alpha, reverse = reverse), ...))
	}
	else{
		return(scale_color_gradientn(colours = rgb_xiangling(n = 512, alpha = alpha, reverse = reverse), ...))
	}
}

#' scale_colour_xiangling
#'
...
#' @examples
#' scale_colour_xiangling()
#' scale_colour_xiangling(FALSE)
#' scale_colour_xiangling(alpha = 0.5)
#' scale_colour_xiangling(FALSE, alpha = 0.7, reverse = TRUE)
scale_colour_xiangling = scale_color_xiangling
...
#' @examples
#' scale_fill_xiangling()
#' scale_fill_xiangling(FALSE)
#' scale_fill_xiangling(alpha = 0.5)
#' scale_fill_xiangling(FALSE, alpha = 0.7, reverse = TRUE)
scale_fill_xiangling = function(discrete = TRUE, alpha = 1, reverse = FALSE, ...) {
	if(discrete){
		return(discrete_scale("fill", "xiangling", pal_xiangling(alpha = alpha, reverse = reverse), ...))
	}
	else{
		return(scale_fill_gradientn(colours = rgb_xiangling(n = 512, alpha = alpha, reverse = reverse), ...))
	}
}
