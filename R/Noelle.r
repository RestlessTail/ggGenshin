...
#' rgb_noelle()
#' rgb_noelle(10)
#' rgb_noelle(n = 10, alpha = 0.5)
#' rgb_noelle(n = 20, alpha = 0.7, reverse = TRUE)
rgb_noelle = function(n = 12, alpha = 1, reverse = FALSE){
	return(pal_noelle(alpha = alpha, reverse = reverse)(n))
}
...
#' @examples
#' scale_color_noelle()
#' scale_color_noelle(FALSE)
#' scale_color_noelle(alpha = 0.5)
#' scale_color_noelle(FALSE, alpha = 0.7, reverse = TRUE)
scale_color_noelle = function(discrete = TRUE, alpha = 1, reverse = FALSE, ...) {
	if(discrete){
		return(discrete_scale("colour", "noelle", pal_noelle(alpha = alpha, reverse = reverse), ...))
	}
	else{
		return(scale_color_gradientn(colours = rgb_noelle(n = 512, alpha = alpha, reverse = reverse), ...))
	}
}
...
#' @examples
#' scale_colour_noelle()
#' scale_colour_noelle(FALSE)
#' scale_colour_noelle(alpha = 0.5)
#' scale_colour_noelle(FALSE, alpha = 0.7, reverse = TRUE)
scale_colour_noelle = scale_color_noelle
...
#' @examples
#' scale_fill_noelle()
#' scale_fill_noelle(FALSE)
#' scale_fill_noelle(alpha = 0.5)
#' scale_fill_noelle(FALSE, alpha = 0.7, reverse = TRUE)
scale_fill_noelle = function(discrete = TRUE, alpha = 1, reverse = FALSE, ...) {
	if(discrete){
		return(discrete_scale("fill", "noelle", pal_noelle(alpha = alpha, reverse = reverse), ...))
	}
	else{
		return(scale_fill_gradientn(colours = rgb_noelle(n = 512, alpha = alpha, reverse = reverse), ...))
	}
}
