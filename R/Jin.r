...
#' rgb_jin()
#' rgb_jin(10)
#' rgb_jin(n = 10, alpha = 0.5)
#' rgb_jin(n = 20, alpha = 0.7, reverse = TRUE)
rgb_jin = function(n = 12, alpha = 1, reverse = FALSE){
	return(pal_jin(alpha = alpha, reverse = reverse)(n))
}
...
#' @examples
#' scale_color_jin()
#' scale_color_jin(FALSE)
#' scale_color_jin(alpha = 0.5)
#' scale_color_jin(FALSE, alpha = 0.7, reverse = TRUE)
scale_color_jin = function(discrete = TRUE, alpha = 1, reverse = FALSE, ...) {
	if(discrete){
		return(discrete_scale("colour", "jin", pal_jin(alpha = alpha, reverse = reverse), ...))
	}
	else{
		return(scale_color_gradientn(colours = rgb_jin(n = 512, alpha = alpha, reverse = reverse), ...))
	}
}
...
#' @examples
#' scale_colour_jin()
#' scale_colour_jin(FALSE)
#' scale_colour_jin(alpha = 0.5)
#' scale_colour_jin(FALSE, alpha = 0.7, reverse = TRUE)
scale_colour_jin = scale_color_jin
...
#' @examples
#' scale_fill_jin()
#' scale_fill_jin(FALSE)
#' scale_fill_jin(alpha = 0.5)
#' scale_fill_jin(FALSE, alpha = 0.7, reverse = TRUE)
scale_fill_jin = function(discrete = TRUE, alpha = 1, reverse = FALSE, ...) {
	if(discrete){
		return(discrete_scale("fill", "jin", pal_jin(alpha = alpha, reverse = reverse), ...))
	}
	else{
		return(scale_fill_gradientn(colours = rgb_jin(n = 512, alpha = alpha, reverse = reverse), ...))
	}
}
